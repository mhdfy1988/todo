...
## 当前指针
- 阶段状态：`v0.1.4` 已通过签名发布闭环成为 GitHub Latest；Windows 卸载注册信息确认当前正式安装基线为改名前的“代办”`v0.1.3`
- 当前正在做：从已安装的 `v0.1.3` 发起 `v0.1.4` 应用内更新，核对发现、下载校验、安装重启和数据保留
- 完成后下一项：在升级后的正式窗口核对“待办”名称、悬浮任务牌图标、已完成入口、父子数据、托盘单实例、再次检查更新结果和日常手感
